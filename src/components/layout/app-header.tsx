        ...
        {topNavigation.map((item) => {
          ...
          if (external || item.to.startsWith("#")) {
            return (
              <a
                key={item.label}
                href={item.to}
                className="focus-ring rounded-md text-sm font-semibold text-[var(--ui-text-secondary)] transition-colors hover:text-[var(--ui-text-primary)]"
              >
                {item.label}
              </a>
            );
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  "focus-ring rounded-md text-sm font-semibold text-[var(--ui-text-secondary)] transition-colors hover:text-[var(--ui-text-primary)]",
