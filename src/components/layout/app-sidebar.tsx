...
export function AppSidebar({
  ...
  function handleMouseLeave() {
    ...
    // Los submenus abiertos manualmente no deben quedar pegados cuando
    // el usuario abandona la barra. El grupo de la ruta activa se conserva
    // mediante activeGroups al volver a expandir el sidebar.
    resetGroupOverrides();
  }
  ...
  function handlePointerDownCapture() {
    ...
    // Un clic deja foco nativo sobre enlaces y botones. Ese foco no debe
    // mantener abierto el sidebar despues de que el puntero salga.
  ...
  function handleKeyDownCapture() {
    ...
    // Si el usuario vuelve a interactuar con teclado mientras el foco
    // permanece dentro del sidebar, la expansion vuelve a ser accesible.
    onFocusWithinChange?.(true);
  }

  function handleFocusCapture() {
    onFocusWithinChange?.(focusOriginRef.current === "keyboard");
  }
